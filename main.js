...
// creates the window in electron
...
// seperates instrumentals using the python logic file "GetAudio.py"
...
// seperates the vocals using the python logic in file "GetAudio.py"
// spleeter seperates instrumentals and vocals in one function
...
// gets each song in the songs-mp3 folder
...
// gets the album name from each song
...
// gets songs for playlists
// same as the other get-songs 
...
// gets the album cover for each song
...
// moves the instrumental to songs-mp3
...
// gets the instrumental files in the specified folder below
...
// gets the vocal files in the specified folder below
...
// sends the api request to youtube for the clean version of the song in the file "Find_Clean_Song.py"
...
// checks for updates in the vocals / instrumentals / cleaned songs / all songs
...
// moves the instrumental or vocal to songs-mp3
...
// moves the cleaned songs to songs-mp3
